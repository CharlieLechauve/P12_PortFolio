...
const englishBio = [
  {
    id: 11,
    data: [
      { id: 1, type: "First Name", value: "Charlie" },
      { id: 2, type: "Last Name", value: "Lechauve" },
      { id: 3, type: "Age", value: "31 Years" },
      { id: 4, type: "Nationality", value: "French" },
  ...
  },
  {
    id: 12,
    data: [
      { id: 6, type: "Address", value: "Paris" },
      { id: 7, type: "Phone", value: "+33 6 85 74 98 82" },
      { id: 8, type: "Email", value: "lechauve.charlie@orange.fr" },
      { id: 9, type: "Linkedin", value: "Lechauve Charlie" },
      { id: 10, type: "Languages", value: "French native, English fluent" },
    ],
  },
];
...
const frenchBio = [
  {
    id: 11,
    data: [
      { id: 1, type: "Prénom", value: "Charlie" },
      { id: 2, type: "Nom", value: "Lechauve" },
      { id: 3, type: "Âge", value: "31 ans" },
      { id: 4, type: "Nationalité", value: "Français" },
      { id: 5, type: "Freelance", value: "Possible" },
    ],
  },
  {
    id: 12,
    data: [
      { id: 6, type: "Adresse", value: "Paris" },
      { id: 7, type: "Téléphone", value: "+33 6 85 74 98 82" },
      { id: 8, type: "E-mail", value: "lechauve.charlie@orange.fr" },
      { id: 9, type: "Linkedin", value: "Lechauve Charlie" },
      { id: 10, type: "Langues", value: "Français natif, Anglais courant" },
    ],
  },
];
...
const englishExp = [
  {
    ...
    title: " Geotechnician ",
    company: " Technosol ",
    desc: " Responsible for organization and prevention on large-scale construction sites ",
  },
  {
    id: 2,
    date: " 2017 - 2019 ",
  ...
  },
  {
    id: 3,
    date: " 2016 - 2017 ",
    title: " Construction site Technician ",
    company: " Technosol ",
    desc: " Site preparation and monitoring ",
  },
];
...
const englishEducations = [
  {
    ...
    title: " Web Developper/Integrator Diploma ",
    unv: " OpenClassRooms ",
    desc: " Creation of 12 professionnal projects using HTML, CSS, Javascript, React, Redux... ",
  },
  {
    id: 2,
    date: " 2017 - 2019 ",
  ...
  return (
    <SectionContainer id="about">
      <div className="w-full">
        ...
        <SectionTitle
          bigTitle={language === "FR" ? "Curriculum" : "Resume"}
          colorTitle={language === "FR" ? "propos" : "me"}
          normalTitle={language === "FR" ? "à" : "about"}
        />
        {/* Section Title Ends */}
        <div className="xl:max-w-1140 custom-md-3:max-w-[calc(100%-195px)] lg:max-w-960 md:max-w-720 sm:max-w-540 xs:max-w-full mx-auto">
          <div className="flex flex-row down-lg:flex-col">
            ...
            <div className="xl:basis-1/2 lg:basis-5/12 down-lg:basis-full">
              ...
              <a
                ...
                href="assets/img/cv-lechauve-charlie.pdf"
                download
              >
                <span
          ...
          />
          <h3 className="uppercase text-fs-26 xs:text-fs-21 pb-48 text-white font-semibold text-center">
            {language === "FR" ? "expérience & éducation" : "experience & education"}
          </h3>
          {/* Resume Starts */}
